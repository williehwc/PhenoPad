...
#define DROPDOWNVIEW_HEADER_HEIGHT 30.
#define RADIUS 5.0f
...
//    [cell addSubview:imgarrow];
    cell.textLabel.font = [UIFont fontWithName:[_kDropDownOption objectAtIndex:row] size:12.];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)) {
        ...
        [_kTitleText drawInRect:titleRect withFont:[UIFont systemFontOfSize:12.]];
